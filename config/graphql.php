...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                ...
                'saveRegistration' => App\GraphQL\Mutations\RegistrationMutation::class,
            ],
        ...
        'user' => [
            'query' => [
                // ExampleQuery::class,
                'getUser' => App\GraphQL\Queries\UserQuery::class,
                'getUsersData' => App\GraphQL\Queries\UserDataQuery::class,
                'deleteUser' => App\GraphQL\Queries\DeleteUserQuery::class,
                'getPermissions' => App\GraphQL\Queries\PermissionQuery::class,
                'deletePermission' => App\GraphQL\Queries\DeletePermissionQuery::class,
                'getRolesData' => App\GraphQL\Queries\RoleDataQuery::class,
                'deleteRole' => App\GraphQL\Queries\DeleteRoleQuery::class,
                
            ],
            'mutation' => [
                'saveAddUser' => App\GraphQL\Mutations\UserAddMutation::class,
                'saveEditUser' => App\GraphQL\Mutations\UserEditMutation::class,
                'saveAddPermission' => App\GraphQL\Mutations\PermissionAddMutation::class,
                'saveEditPermission' => App\GraphQL\Mutations\PermissionEditMutation::class,
                'saveAddRole' => App\GraphQL\Mutations\RoleAddMutation::class,
                'saveEditRole' =>  App\GraphQL\Mutations\RoleEditMutation::class,
            ],
    ...
    'types' => [
        ...
        'UserDataType' => App\GraphQL\Types\UserDataType::class,
        'RoleType' => App\GraphQL\Types\RoleType::class,
        'EachRoleType' => App\GraphQL\Types\EachRoleType::class,
        'PermissionType' => App\GraphQL\Types\PermissionType::class,
        'RoleDataType' => App\GraphQL\Types\RoleDataType::class,


        //inputs
        'LoginInput' => App\GraphQL\InputObject\LoginInput::class,
        'UserInput' => App\GraphQL\InputObject\UserInput::class,
        'PermissionInput' => App\GraphQL\InputObject\PermissionInput::class,
        'RoleInput' =>  App\GraphQL\InputObject\RoleInput::class,
    ],
